...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < titles.length; i++) {
            ...
            FileCreator.createSampleFile("./myBooks", "The Great Gatsby.txt", "...");
            FileCreator.createSampleFile("./myBooks", "1984.txt", "...");
            FileCreator.createSampleFile("./myBooks", "To Kill a Mockingbird.txt", "...");
        }
