...
public class DirectoryManager {
    ...
    public static void listFilesAndDirectories(String directoryPath) {
        ...
        if (files == null || files.length == 0) {
            ...
            System.out.println("The contents of the directory are: " + directoryPath);
            for (File file : files) {
    ...
    public static void createDirectory(String directoryPath) {
        ...
        if (!directory.exists()) {
            ...
            System.out.println("directory successfully created: " + directoryPath);
    ...
    public static void renameDirectory(String currentDirectory, String newDirectory) {
        ...
        if (newDir.exists()) {
            System.out.println("Cannot rename. directory already exists" + newDirectory);
            return;
        }
        ...
        if (!oldDir.renameTo(newDir)) {
            ...
            System.out.println("Directory successfully renamed" + newDirectory);
        }
    }
    ...
    public static void copyFiles(String sourceDir, String destDir) {
        ...
        try {
            ...
            for (File file : files) {
                ...
                System.out.println("Files were successfully copied: " + file.getName());
    ...
    public static void deleteFile(String fileName) {
        ...
        if (file.delete()) {
            ...
            System.out.println("File not delected " + fileName);
        }
    }
