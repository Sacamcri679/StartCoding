...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            switch (animalChoiceMenu(keyboard)) {
                ...
                case 4:
                    System.out.print(("Save animals to file"));
                ...
                case 5:
                    System.out.println("Display saved animals from file");
                    readObjectsFromFile();
                    break;
    ...
    public static void readObjectsFromFile(){
        try(ObjectInputStream in = new ObjectInputStream(new FileInputStream("tiger.txt"))) {
            Tiger tiger1 = (Tiger) in.readObject();
            System.out.println("Tiger from file: " + tiger1);
        }catch(IOException | ClassNotFoundException e) {
            e.printStackTrace();
        }
        try(ObjectInputStream in = new ObjectInputStream(new FileInputStream("penguin.txt"))) {
            Penguin penguin1 = (Penguin) in.readObject();
            System.out.println("Penguin from file: " + penguin1);
        }catch(IOException | ClassNotFoundException e) {
            e.printStackTrace();
        }
        try(ObjectInputStream in = new ObjectInputStream(new FileInputStream("dolphin.txt"))) {
            Dolphin dolphin1 = (Dolphin) in.readObject();
            System.out.println("Dolphin from file: " + dolphin1);
        }catch(IOException | ClassNotFoundException e) {
            e.printStackTrace();
        }
